...
Software Engineer | Systems and Full-Stack Architect
Undergraduate in Computer Science at South Asian University ('29)

[Portfolio](https://crag.web.app) | [LinkedIn](https://www.linkedin.com/in/raghav-goyal-linkd/) | [Email](mailto:goyalraghav1442@gmail.com)

---

## Technical Focus

* **Systems Engineering and Privacy:** Low-latency WinAPI process hooking, desktop application isolation, and native Windows utilities built with Rust and Tauri.
* **Modern Web Architectures:** Responsive full-stack applications, Progressive Web Apps (PWA), and 3D spatial interfaces built with TypeScript, React, Next.js, and Vanilla CSS matrices.
* **Autonomous Workflows and Cloud:** Tool-calling pipelines, stateful graph coordination, and serverless backends deployed across Google Cloud Platform (GCP) and Firebase.
...
| Domain | Technologies |
| :--- | :--- |
| **Languages** | Rust, TypeScript, JavaScript (ES6+), Python, HTML5, CSS3, SQL |
| **Frameworks and Libraries** | React, Next.js (App Router), Tauri, Node.js, Tailwind CSS |
| **Cloud and Distributed** | Google Cloud Platform (GCP), Firebase (Firestore, Auth, Hosting), Edge Middleware |
| **Tools and Systems** | Git, GitHub Actions, Linux, Windows API, Vite |

---

## Featured Architectures

### [StreamShield](https://github.com/raghavatgit/StreamShield)
* **Stack:** Rust, Tauri, Windows API, React, TypeScript
...
* Calculates real-time cursor trajectory and velocity to apply perspective matrices, dynamic lighting shaders, and tactile spring physics without third-party graphics engines.
* Live demo: [contactraghav.web.app](https://contactraghav.web.app)

### [Zenflow-3D](https://github.com/raghavatgit/Zenflow-3D)
* **Stack:** JavaScript, CSS3 Spatial Hierarchies
* Kinetic spatial interface and deep work dashboard prototype showcased at the ACM Tech Symposium.
* Implements multi-layered CSS perspective planes and card hover physics for distraction-free task management.
...
| **DSA Patterns** | Algorithms & Complexity | LeetCode Solved Catalog, Patience Sort, Dual-Heap, Tries | [Repository](https://github.com/raghavatgit/dsa-patterns) |
